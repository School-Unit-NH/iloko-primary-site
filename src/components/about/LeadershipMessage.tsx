        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-serif font-bold mb-6 leading-tight text-white">
              "IMKA is a place where excellence is not just a goal, but a lifestyle."
            </h2>

            <div className="space-y-4 text-slate-300 text-lg mb-10 leading-relaxed">
              <p>
                Welcome to Iloko Model Kiddies Academy. We nurture the mind,
                body, heart, and spirit of every child through a safe, warm,
                and disciplined learning environment.
              </p>
              <p>
                We believe a child is more than examination scores. That is why
                we build character, creativity, physical vitality, and
                emotional intelligence alongside strong academics.
              </p>
            </div>

            <div>
              <h4 className="text-2xl font-bold text-white mb-1">
                Fatomilola Oladosu Abiodun
              </h4>
              <p className="text-iloko-yellow uppercase tracking-wider text-sm font-semibold">
                Principal
              </p>
            </div>
          </motion.div>
